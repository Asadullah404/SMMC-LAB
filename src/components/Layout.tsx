...
const Layout = ({
  ...
  return (
    <div className="min-h-screen bg-background transition-medical flex flex-col">
      ...
      <header className="border-b bg-card card-shadow sticky top-0 z-50">
        <div className="container mx-auto px-3 sm:px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Search (mobile - inside drawer trigger) */}
      ...
      {/* Main */}
      <main className="flex-1 container mx-auto px-3 sm:px-4 py-6 space-y-8">
        {children}
      </main>

      {/* Footer */}
      <footer className="border-t bg-muted/50 mt-8">
        <div className="container mx-auto px-3 sm:px-4 py-4 text-center text-xs md:text-sm text-muted-foreground">
          © 2025 Laboratory Report Generator
        </div>
      </footer>
    </div>
